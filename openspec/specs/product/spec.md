...
3. **Continuidad:** tras autenticarse, dirigir al usuario a un **shell** (layout principal) con secciones navegables (**Inicio**, **Proyectos**, **Comunidad**, **Recompensas**, **Ajustes**).
...
- **Shell:** `IndexedStack` con secciones; **drawer** con navegación (cuatro entradas en lista scrollable — Inicio, Proyectos, Comunidad, Recompensas — + **Ajustes** y **Cerrar sesión** en el pie); **selector de idioma** (banderas) en la parte inferior del drawer; pestaña de biblioteca pública renombrada a **Comunidad** en copy (i18n).
